...
async function generateStoryBreakdown(
  ...
  try {
    ...
    const adjustedScenes = scenes.map((scene, idx) => {
      const adjustedNarration = (0, narrationHelper_1.adjustTextForDuration)(
        scene.narration,
        scene.duration,
      );
      const originalDuration = (0, narrationHelper_1.estimateTextDuration)(
        scene.narration,
      );
      const adjustedDuration = (0, narrationHelper_1.estimateTextDuration)(
        adjustedNarration,
      );
